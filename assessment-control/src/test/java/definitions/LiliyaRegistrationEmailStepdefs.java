...
public class LiliyaRegistrationEmailStepdefs {
    ...
    public void matErrorDisplayed(String errorMessage) {
        String errorPage = getDriver().findElement(By.xpath("//mat-error")).getText();
        System.out.println(errorPage);
        assertThat(errorPage.equals(errorMessage)).isTrue();
        assertThat(errorPage).isEqualTo(errorMessage);
    }
    ...
    public void errorMessageDisplayed(String errorMsg) {
        String errorPage = getDriver().findElement(By.xpath("//mat-error[contains(text(),'"+errorMsg+"')]")).getText();
        assertThat(errorPage.equals(errorMsg)).isTrue();
    ...
    @And("I input new email into email field")
    public void iInputNewEmailIntoEmailField() {
        Random randomGenerator = new Random();
        int randomInt = randomGenerator.nextInt(100);
        String newEmail = "username"+ randomInt +"@gmail.com";
        System.out.println(newEmail);
